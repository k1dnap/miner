...
teamredminer.exe -a autolykos2 -o stratum+tcp://hk.ergo.herominers.com:10250 -u 9hit7mQReYpoXSH3J9osv2ci2muDBxKs8mgWCYdr3r79pUc7uBp.aa11 --watchdog_script --log_file --fan_control=:::65,:::65,:::65,:::65,:::65,:::65,:::65,:::65,:::65 -p x --api_listen=4028
